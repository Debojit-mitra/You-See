...
public class EpisodeGroupsAdapter extends RecyclerView.Adapter<EpisodeGroupsAdapter.Holder> {
    ...
    public EpisodeGroupsAdapter(Context context, ArrayList<EpisodesGroups> episodesGroupsArrayList, OnButtonClickListener buttonClickListener) {
    ...
    @NonNull
    @Override
    public EpisodeGroupsAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.episode_groups_layout, parent, false);
        return new Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull EpisodeGroupsAdapter.Holder holder, int position) {
